...
var _ensureFileContent = _interopRequireDefault(require("../../../urb-base-server/ensureFileContent"));
...
var _schema = _interopRequireDefault(require("../../../urb-appbase-server/graphql/schema"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // $AssureFlow Not sure why it gives an error. The file does exist
...
async function createGraphQLSchema(units) {
  ...
  _path.default.resolve('./units/_configuration/urb-base-server/graphql/schema.json'),
  null,
...
async function createRoutes(units) {
  ...
  await Promise.all([
  createRouteFile(
  _path.default.resolve('./units/_configuration/urb-appbase-webapp/routesAppFrame.js'),
  routesAppFrameImports,
  routesAppFrameExports),

  createRouteFile(
  _path.default.resolve('./units/_configuration/urb-appbase-webapp/routesRoot.js'),
  routesRootImports,
  routesRootExports)]);
