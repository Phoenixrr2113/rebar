...
class ForceLogin extends _react2.default.Component {
  render() {
    ...
    if (Viewer.User_IsAnonymous) return _react2.default.createElement(_RequiresAuthentication2.default, null);
      ...
      return (
        _react2.default.createElement(_ResponsiveContentArea2.default, null,
          _react2.default.createElement(_Card2.default, { className: classes.card },
            _react2.default.createElement(_Card.CardHeader, { title: 'Only Authorized', subheader: 'Only users who log in see this.' }),
