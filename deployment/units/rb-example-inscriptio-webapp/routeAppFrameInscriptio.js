...
_react.default.createElement(_reactCodeSplitting.default, { load: Promise.resolve().then(() => _interopRequireWildcard(require('./components/InscriptioScreen'))), componentProps: props });var _default =
